...
public class Game : MonoBehaviour
{
    ...
    public static float _HotelTime
    {
        ...
        set
        {
            ...
            Instance.TimeIndicator.text = $"{(int)(value / 3600f)}÷ {(int)(value % 3600 / 60f)}ì {(int)(value % 60)}ñ";
        }
    }
    ...
    private IEnumerator Timer()
    {
        ...
        {
            HotelTime++;
            TimeIndicator.text = $"{(int)(HotelTime / 3600f)}÷ {(int)(HotelTime % 3600 / 60f)}ì {(int)(HotelTime % 60)}ñ";
